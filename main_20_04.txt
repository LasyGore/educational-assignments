...
myHouse = House()
#myHouse.setNewNumberOfFloors(3)  # Вызов метода для изменения этажности и вывода в консоль
NumFlo=input ("Укажите требуемую этажность:")
myHouse.setNewNumberOfFloors(NumFlo)